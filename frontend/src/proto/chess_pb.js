 ...
 * @return {string}
 */
proto.pb.Player.prototype.getName = function() {
 ...
 * @return {!proto.pb.Player} returns this
 */
proto.pb.Player.prototype.setName = function(value) {
...
proto.pb.Game.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    playerone: (f = msg.getPlayerone()) && proto.pb.Player.toObject(includeInstance, f),
    playertwo: (f = msg.getPlayertwo()) && proto.pb.Player.toObject(includeInstance, f),
...
/**
 * optional Player playerTwo = 3;
 * @return {?proto.pb.Player}
 */
proto.pb.Game.prototype.getPlayertwo = function() {
  return /** @type{?proto.pb.Player} */ (
    jspb.Message.getWrapperField(this, proto.pb.Player, 3));
};
